        ...
        <section className="relative h-screen">
            ...
            <div className="bg-cover bg-center bg-fixed min-h-screen relative z-10">
                <div className="container  py-20">
                    <h1 className="text-4xl text-white font-extrabold mb-10 text-center">Adopt a Pet</h1>
                    <div className="flex flex-wrap justify-center -mx-4">
                        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-8">
                            <div className="bg-white rounded-lg shadow-lg p-6">
                                ...
                                <a href="/Pet" className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded inline-block">View Dogs</a>
                            </div>
                        </div>
                        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-8">
                            <div className="bg-white rounded-lg shadow-lg p-6">
                                ...
                                <a href="/Cat" className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded inline-block">View Cats</a>
                            </div>
                        </div>
                        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-8">
                            <div className="bg-white rounded-lg shadow-lg p-6">
                                ...
                                <a href="/Fish" className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded inline-block">View Fish</a>
                            </div>
                        </div>
                        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-8">
                            <div className="bg-white rounded-lg shadow-lg p-6">
                                ...
                                <a href="/Bird" className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded inline-block">View Birds</a>
                            </div>
                        </div>
                    </div>
                </div>
